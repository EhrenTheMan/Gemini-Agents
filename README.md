...
## To install all agents
  ...
  - When downloaded, open the file, or exctract it somewhere temporary
...
# How to enable/use a skill
  ...
  - in the bottom left of Obsidian, right click on the vaut dropdown and select "Open in System Explorer"
  - From there,
    -  On windows:
  ...
  - Obsidian-Scribe Supports a number of commands that fall under two categories. Commandline commands, and Note commands.
  - **Before you use those**, make sure you tell the agent where you are working (if you are working in a specific directory).
    ...
    ### Commandline Commands
      - `rescan` - This command tells the agent to rescan the Note you are currently working in. **ONLY scans the note you told it you were working in.**
